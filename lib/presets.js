export default {
    ...
    letterboxdNoPoster: {
        ...
        format: (data) => {
            ...
            const output = getOutputTrimmedToCharacterLimit(data.title, data.link, content, 299);
    ...
    backloggd: {
        ...
        format: (data) => {
            ...
            const output = getOutputTrimmedToCharacterLimit(data.title, data.link, contentSnippet, 299);
    ...
    goodreads: {
        ...
        format: (data) => {
            ...
            const output = getOutputTrimmedToCharacterLimit(title, data.link, review, 299);
...
function getOutputTrimmedToCharacterLimit(title, link, review, characterLimit){
    ...
    const cleanedOutputForLength = output.replace(placeholderText,"").replace(/\<br \/\>/g," ");
    console.log("cleaned output", cleanedOutputForLength);
    ...
    output = output.replace(placeholderText, review).replace("\"\"","");
    return output;
}
